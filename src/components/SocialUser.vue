<template>
   <section id="userProfile" class="bg-light">
        <div class="flex-items">
            ...
            <div>
             <button @click="showSocialMedia(link)">Follow</button>
            </div>
        </div>
      </section>
</template>
